...
def decoder(bytes_data, port):
    ...
    if port == 1:
        ...
        if bytes_data[1] & 0x01:
            decoded["tof_status"] = bytes_data[byte_cnt]
            byte_cnt += 1
            decoded["tof_distance"] = (bytes_data[byte_cnt] << 8) | bytes_data[byte_cnt + 1]
            byte_cnt += 2
            decoded["tof_index"] = bytes_data[byte_cnt]
            byte_cnt += 1

        # Radar
        if bytes_data[1] & 0x02:
            decoded["radar_status"] = bytes_data[byte_cnt]
            byte_cnt += 1
            decoded["radar_no_peaks"] = bytes_data[byte_cnt]
            byte_cnt += 1

            decoded["radar_distance_1"] = (bytes_data[byte_cnt] << 8) | bytes_data[byte_cnt + 1]
            byte_cnt += 2
            ...
            decoded["radar_distance_2"] = (bytes_data[byte_cnt] << 8) | bytes_data[byte_cnt + 1]
            byte_cnt += 2
            ...
            decoded["radar_distance_3"] = (bytes_data[byte_cnt] << 8) | bytes_data[byte_cnt + 1]
            byte_cnt += 2
        ...
        if bytes_data[1] & 0x04:
            decoded["acc_status"] = "Fehler" if bytes_data[byte_cnt] else "OK"
            byte_cnt += 1
            decoded["acc_orientation"] = bytes_data[byte_cnt]
            byte_cnt += 1
            decoded["acc_open"] = bytes_data[byte_cnt]
            byte_cnt += 1
            decoded["acc_open_cnt"] = (bytes_data[byte_cnt] << 8) | bytes_data[byte_cnt + 1]
            byte_cnt += 2
            decoded["acc_impact"] = "Vandalismus" if bytes_data[byte_cnt] else "OK"
            byte_cnt += 1

        # Hall
        if bytes_data[1] & 0x08:
            decoded["hall_open"] = bytes_data[byte_cnt]
            byte_cnt += 1
            decoded["hall_open_cnt"] = (bytes_data[byte_cnt] << 8) | bytes_data[byte_cnt + 1]
            byte_cnt += 2
